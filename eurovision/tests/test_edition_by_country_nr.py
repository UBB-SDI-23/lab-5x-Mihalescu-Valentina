...
class EditionsByNrCountriesTestCase(TestCase):
    def setUp(self):
    ...
    def test_get_tutors_by_avg_student_age(self):
        ...
        self.assertEqual(response.data[0]['country_nr'], 3)
        ...
        self.assertEqual(response.data[1]['country_nr'], 1)
