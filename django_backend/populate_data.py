...
def add_constraints_indexes():
    ...
    file.write("ALTER TABLE eurovision_venue ADD CONSTRAINT eurovision_venue_host_city_id_id_dc4c2aff_fk_eurovisio FOREIGN key(hostcity_id_id) references eurovision_hostcity(id) on delete cascade;\n")
